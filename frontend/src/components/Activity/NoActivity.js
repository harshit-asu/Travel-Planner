...
const NoActivity = ( {trip, open, close, setOpen, setAlertData, fetchActivities} ) => {
  return (
    <MDBContainer className="my-5">
        ...
        <AddActivity trip={trip} open={open} close={close} setAlertData={setAlertData} fetchActivities={fetchActivities} />
