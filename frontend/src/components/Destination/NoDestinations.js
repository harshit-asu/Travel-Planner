...
const NoDestinations = ( {trip, open, close, setOpen, setAlertData, fetchDestinations} ) => {
  return (
    <MDBContainer className="my-5">
        ...
        <AddDestination trip={trip} open={open} close={close} setAlertData={setAlertData} fetchDestinations={fetchDestinations} />
